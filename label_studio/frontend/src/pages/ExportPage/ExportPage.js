  ...
  return (
    <Block name="formats">
      ...
      <Elem name="feedback">
        ...
        <br/>
        Please let us know in <a className="no-go" href="http://slack.labelstudio.heartex.com?source=product-export">Slack</a> or submit an issue to the <a className="no-go" href="https://github.com/heartexlabs/label-studio-converter/issues">Repository</a>
      </Elem>
    </Block>
  );
};
